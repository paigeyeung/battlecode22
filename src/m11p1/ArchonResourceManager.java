...
strictfp class ArchonResourceManager {
    static final int MAX_DISTANCE_TO_NEARBY_ALLY_ARCHON = 100;
    static final double MINER_BUILD_PROPORTION = 0.3;
...
//            }
    ...
    static int findArchonNeedingSoldiers() throws GameActionException {
        ...
        if(index != -1) return index;
        return ArchonTrackerManager.getNearestAllyArchon(GeneralManager.myLocation);
