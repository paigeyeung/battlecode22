...
strictfp class ArchonStrategy {
    ...
    static boolean archonTryBuild(RobotController rc, RobotType robotType) throws GameActionException {
    ...
    static void runArchon(RobotController rc) throws GameActionException {
        ...
        if (GeneralManager.turnsAlive == 1) {
            ...
            nearestLeadLocation = GeneralManager.getNearestLeadLocation(rc);
            if (nearestLeadLocation == null) {
                DebugManager.log(rc, "SOMETHING WENT WRONG: Nearest lead not found!");
            }

            // Build a miner
            archonTryBuild(rc, RobotType.MINER);
        ...
        if (action == ArchonResourceManager.ARCHON_ACTIONS.BUILD_MINER) {
            ...
            archonTryBuild(rc, RobotType.BUILDER);
        }
        else if (action == ArchonResourceManager.ARCHON_ACTIONS.BUILD_SOLDIER) {
            archonTryBuild(rc, RobotType.SOLDIER);
        }
